...
const ProjectDescription: React.FC = () => {
  return (
    <div className="w-full sm:w-2/3 max-w-xl mt-6 sm:mt-0 sm:ml-6 px-4 sm:px-0 pt-14">
      {/* Name */}
      <div className="text-xl sm:text-2xl font-bold">BPF-Best Promotion for Fund</div>
      {/* Description */}
      ...
      <div className="flex flex-row w-full sm:w-min gap-4 items-center rounded">
        <div className="bg-slate-300 px-4 sm:px-5 py-2 my-5 font-semibold shadow-inherit text-lg sm:text-xl rounded-md text-center">Private Github</div>
      </div>
    </div>
  );
};
