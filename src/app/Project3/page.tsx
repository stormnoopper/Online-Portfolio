...
const ProjectDescription: React.FC = () => {
  return (
    <div className="w-full sm:w-2/3 max-w-xl mt-6 sm:mt-0 sm:ml-6 px-4 sm:px-0 pt-14">
      {/* Name */}
      <div className="text-xl sm:text-2xl font-bold">Discord Gemini Bot</div>
      {/* Description */}
      <div className="mt-2 ml-0 sm:ml-2 text-lg sm:text-xl">
        This is my National ITMX Intern project about a Discord bot built with the Gemini 1.5 API in Golang, allowing for direct conversations in Discord.
      </div>
      {/* Button */}
