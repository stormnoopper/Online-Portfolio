...
const ProjectDescription: React.FC = () => {
  return (
    <div className="w-2/3 max-w-xl ml-6">
      {/* Name */}
      <div className="text-2xl font-bold">Shopdee</div>
      {/* Description */}
      <div className="mt-2 ml-2 text-xl">
        This is my National ITMX Intern project that about an online shopping website built with a Next.js frontend,a Java Spring Boot backend and a MySQL database.
      </div>
      {/* Button */}
